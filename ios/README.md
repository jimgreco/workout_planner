# Rep, Mix, Burn iPhone App

Native SwiftUI iPhone client for the Rep, Mix, Burn API. It mirrors the
...
4. In `ios/project.yml`, set:
   - `API_BASE_URL` to the deployed API base URL, usually `https://repmixburn.com/api`
...
Apple sign-ins pointed at the same Rep, Mix, Burn data, sign in with Google and use
