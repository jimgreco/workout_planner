...
struct SmithWeightCheck {
    static func main() throws {
        ...
        precondition(effectiveRecordedWeight("0", weightType: "bar_double") == 45)
        precondition(effectiveRecordedWeight("", weightType: "bar_double") == 0)
        precondition(calculatedWeightCaption(weight: "0", weightType: "bar_double") == "Total 45 lbs")
        precondition(calculatedWeightCaption(weight: "", weightType: "bar_double") == nil)
        precondition(bestPersonalBestCandidate(from: [WorkoutSet(reps: "10", weight: "0")], weightType: "bar_double")?.weightValue == 45)
